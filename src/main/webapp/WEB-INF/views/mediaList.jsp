                ...
                <div class="am-u-sm-12 am-u-md-6">
                    <div class="am-btn-toolbar">
                        <div class="am-btn-group am-btn-group-xs">
                            <button type="button" class="am-btn am-btn-default am-btn-success" id="newMediaBtn"><span class="am-icon-plus"></span> 新增</button>
                    ...
                    <form class="am-form">
                        <table class="am-table am-table-striped am-table-hover table-main">
                            ...
                            <tr>
                                ...
                                <th class="table-title">素材ID（微信）</th>
...
<script type="text/javascript">
    $(function () {
        ...
        $("#newMediaBtn").click(function () {
            window.location.href = '${pageContext.request.contextPath}/toUploadPage';
        });
    })
