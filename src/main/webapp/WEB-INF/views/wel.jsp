                ...
                <div class="tpl-portlet">
                    ...
                    <div class="tpl-scrollable">
                        ...
                        <table class="am-table tpl-table">
                            ...
                            <tr>
                                <td>
                                    <img src="${pageContext.request.contextPath}/images/user01.png" alt="" class="user-pic">
                            ...
                            <tr>
                                <td>
                                    <img src="${pageContext.request.contextPath}/images/user02.png" alt="" class="user-pic">
                            ...
                            <tr>
                                <td>
                                    <img src="${pageContext.request.contextPath}/images/user03.png" alt="" class="user-pic">
                            ...
                            <tr>
                                <td>
                                    <img src="${pageContext.request.contextPath}/images/user04.png" alt="" class="user-pic">
                            ...
                            <tr>
                                <td>
                                    <img src="${pageContext.request.contextPath}/images/user05.png" alt="" class="user-pic">
                            ...
                            <tr>
                                <td>
                                    <img src="${pageContext.request.contextPath}/images/user06.png" alt="" class="user-pic">
